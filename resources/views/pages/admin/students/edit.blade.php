                    ...
                    <form action="{{ route('admin.students.update', $student) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control" value="{{ old('phone', $student->phone) }}" placeholder="+998 90 123 45 67">
                                @error('phone')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="login" id="login" class="form-control" value="{{ old('login', $student->login) }}" placeholder="{{ __('Enter login') }}">
                                @error('login')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
