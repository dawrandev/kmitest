                ...
                <li class="language-nav">
                    <div class="translate_wrapper">
                        <div class="current_lang">
                            <div class="lang"><i class="flag-icon flag-icon-{{ config('app.locale') }}"></i><span class="lang-txt">{{ config('app.locale') }}</span></div>
                        </div>
                        <div class="more_lang">
                            @foreach (config('app.locales') as $key => $locale)
                            <a href="{{ route('set.locale', $key) }}">
                                <div class="lang {{ app()->getLocale() === $key ? 'selected' : '' }}" data-value="{{ $key }}">
                                    <i class="flag-icon flag-icon-{{ $key }}"></i>
                                    <span class="lang-txt">{{ $locale }} <span>({{ $key }})</span></span>
                                </div>
                            </a>
                            @endforeach
                        </div>
